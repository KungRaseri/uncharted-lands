...
<div class="space-y-2" role="region" aria-label="Building Area Information">
	...
	<div class="flex items-center justify-between">
		<span class="text-sm font-medium text-surface-700 dark:text-surface-300 flex items-center gap-1">
		...
		<span class="text-xs px-2 py-0.5 rounded bg-primary-100 dark:bg-primary-900/30 text-primary-700 dark:text-primary-400 font-medium">
			TH Lv.{townHallLevel}
		</span>
	</div>
	...
	{:else}
		...
		<!-- Warning Messages -->
		{#if percentUsed >= 100}
			<div class="mt-2 p-2 rounded bg-error-50 dark:bg-error-900/20 border border-error-200 dark:border-error-800">
		...
		{:else if percentUsed >= 90}
			<div class="mt-2 p-2 rounded bg-warning-50 dark:bg-warning-900/20 border border-warning-200 dark:border-warning-800">
